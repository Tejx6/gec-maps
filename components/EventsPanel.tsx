...
const EventsPanel: React.FC<EventsPanelProps> = ({ events }) => {
    ...
    return (
        <div className="absolute bottom-4 left-4 z-10 p-4 w-72 bg-gray-900/80 backdrop-blur-md rounded-lg border border-white/10 shadow-lg text-white animate-fade-in-up">
