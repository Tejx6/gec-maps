    ...
    return (
        ...
        >
            ...
            >
                ...
                {locations.map(location => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {isHovered && !isAddMode && (
                                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-6 w-64 p-4 bg-black/40 backdrop-blur-lg rounded-lg border border-white/10 shadow-xl pointer-events-none animate-fade-in-up">
             ...
             {isAddMode && (
                <p className="absolute top-24 left-1/2 -translate-x-1/2 text-lg font-medium text-cyan-200 bg-black/30 px-4 py-2 rounded-full animate-pulse">
