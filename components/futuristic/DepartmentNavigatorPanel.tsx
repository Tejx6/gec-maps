...
const DepartmentNavigatorPanel: React.FC<DepartmentNavigatorPanelProps> = ({ isVisible, onClose, locations }) => {
    ...
    return (
        <div className={`absolute top-0 left-0 h-full w-[420px] max-w-full z-30 transform transition-transform duration-500 ease-in-out ${isVisible ? 'translate-x-0' : '-translate-x-full'}`}>
            <div className="h-full w-full bg-black/50 p-4 backdrop-blur-2xl border-r border-gray-800 flex flex-col">
                {/* Header */}
                <div className="flex-shrink-0 p-2">
                    <div className="flex items-center justify-between">
                         <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-xl font-bold text-white">Department Navigator</h2>
                                <p className="text-sm text-gray-400">Explore campus facilities</p>
                            </div>
                        </div>
                    ...
                    <div className="relative mt-4">
                        ...
                        <input 
                            type="text"
                            placeholder="Search departments, labs, facilities..."
                            value={searchQuery}
