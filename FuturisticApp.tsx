...
const Upload360Screen: React.FC<Upload360ScreenProps> = ({ locations, onUpdateLocationImage }) => {
    ...
    return (
        <div className="absolute inset-0 pt-24 z-10 p-6 flex flex-col animate-fade-in-up">
            <div className="flex-shrink-0 bg-black/30 backdrop-blur-md rounded-xl border border-white/10 p-4 mb-6">
                <div className="flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-white">360° Image Upload</h2>
                            <p className="text-sm text-gray-400">Add panoramic images for department street views</p>
                        </div>
                    </div>
                    <div className="relative">
                        <span className="absolute inset-0 bg-cyan-500 rounded-full blur-md opacity-60"></span>
                        <span className="relative px-4 py-1.5 text-sm font-medium bg-cyan-600 rounded-full border border-cyan-400">{totalUploadedImages} Images</span>
                    </div>
                </div>
            </div>
            ...
            <div className="flex-grow grid grid-cols-1 lg:grid-cols-2 gap-6">
                {/* Left Panel */}
                <div className="bg-black/30 backdrop-blur-md rounded-xl border border-white/10 p-6 flex flex-col">
...
const FuturisticApp: React.FC<FuturisticAppProps> = ({ 
    ...
    return (
        <div className="w-screen h-screen overflow-hidden font-sans text-white bg-transparent">
            ...
            {activeTab === 'Street View' && <div className="flex items-center justify-center h-full text-2xl text-gray-400"><p>Select a location on the map to enter Street View.</p></div>}
